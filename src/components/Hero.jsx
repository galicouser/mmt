...
<div className="flex flex-col-reverse md:flex-row bg-blue-900">
  ...
  <div className="rounded-lg overflow-hidden min-h-[400px] flex items-center justify-center bg-blue-900 bg-opacity-60 p-6 md:p-8 lg:p-12 text-white">
    <section className="w-full">
      {/* Content */}
      <div className="rounded-b-md">
        <h3 className="text-xl font-semibold mb-4">We offer full cleaning services:</h3>
        ...
        <div className="text-left mt-4">
          <p className="text-lg mb-2">
            ...
            <a href="tel:+12675977272" className="text-sm md:text-base font-bold text-white hover:text-yellow-400"> +1-267-597-7272</a>
          </p>
          <p className="text-sm">Please leave a message; we'll return your call promptly.</p>
          <p className="text-sm">
            <span className="font-bold">Email:</span>
            <a href="mailto:margaretclean@hotmail.com" className="text-sm md:text-base font-bold text-white hover:text-yellow-400"> margaretclean@hotmail.com</a>
          </p>
        </div>
      </div>

      {/* Slogan and Info */}
      <div className="bg-blue-700 bg-opacity-70 p-4 rounded-md mt-6 text-center">
