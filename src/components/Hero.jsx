...
import '../assets/css/header.css'; // Ensure you have this CSS for additional styling if needed
  ...
  return (
    <div className="flex bg-blue-900">
      ...
      <div className="relative w-1/2 flex items-center justify-center">
        <div className=" rounded-lg overflow-hidden h-96 flex items-center justify-center"> {/* Larger Circular Container */}
          <div> {/* Maintain Aspect Ratio */}
            <ReactPlayer
              url={videoSource}
              playing={true}
              loop={true}
      ...
      <div className="relative w-1/2 flex items-center justify-center p-8">
        <div className="relative">
          <img src={heroImage} alt="Cleaning Service" className="w-full h-auto" /> {/* Your image */}
          <div className="absolute inset-0 flex flex-col items-start justify-center bg-blue-900 bg-opacity-60 p-8">
            <h1 className="text-5xl font-extrabold text-white mb-4">Sparkling Clean Homes, Every Time</h1>
